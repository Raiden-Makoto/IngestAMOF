...
class CrystalDiffusionVAE(nn.Module):
    def __init__(self, hidden_dim=128, latent_dim=64, num_layers=3, num_timesteps=1000, use_checkpoint=True):
        super().__init__()
        self.use_checkpoint = use_checkpoint
        self.encoder = CrystalEncoder(hidden_dim, latent_dim, num_layers, use_checkpoint=False)
